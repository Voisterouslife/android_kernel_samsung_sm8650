...
LOCALVERSION=-android14-Kokuban-Elysia-AYB6-SukiSU
...
name=S24_ZFlip6_ZFold6_ZFold6SE_W25Flip_W25_${TARGET_DEFCONFIG%%_defconfig}_kernel_`cat include/config/kernel.release`_`date '+%Y_%m_%d'`
cd AnyKernel3
